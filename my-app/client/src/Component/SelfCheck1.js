const FrameComponent1 = () => {
    return (
      <div className="relative bg-lavenderblush w-full h-[379.38rem] overflow-hidden text-left text-[0.94rem] text-black font-poppins">
        <img
          className="absolute top-[0.19rem] left-[0rem] w-[90rem] h-[49.06rem]"
          alt=""
          src="/vector11.svg"
        />
        <img
          ...
          alt=""
          src="/fixedwidth-fixedheight-sec.svg"
        />
        <nav className="absolute top-[1.19rem] left-[34.75rem] w-[53.69rem] h-[3.31rem]">
          ...
          <button className="cursor-pointer [border:none] p-0 bg-[transparent] absolute top-[1rem] left-[18.13rem] text-[1.13rem] font-bold font-poppins text-gray-200 text-left inline-block">
            About us
          </button>
          <button className="cursor-pointer [border:none] p-0 bg-[transparent] absolute top-[1rem] left-[12.19rem] text-[1.13rem] font-bold font-poppins text-gray-200 text-left inline-block">
            Home
          </button>
          <button className="cursor-pointer [border:none] p-0 bg-[transparent] absolute top-[1rem] left-[40.19rem] text-[1.13rem] font-bold font-poppins text-gray-200 text-left inline-block">
            Login
          </button>
          <button className="cursor-pointer [border:none] p-0 bg-[transparent] absolute top-[1rem] left-[47.19rem] text-[1.13rem] font-bold font-poppins text-light-background-color text-left inline-block">
            Sign Up
          </button>
          <button className="cursor-pointer [border:none] p-0 bg-[transparent] absolute top-[1rem] left-[26.63rem] text-[1.13rem] font-bold font-poppins text-gray-200 text-left inline-block">
            User
          </button>
          <button className="cursor-pointer [border:none] p-0 bg-[transparent] absolute top-[1rem] left-[32.44rem] text-[1.13rem] font-bold font-poppins text-deeppink text-left inline-block">{`Doctor `}</button>
        </nav>
        <img
          className="absolute top-[0.69rem] left-[1.31rem] w-[6.5rem] h-[6.13rem] object-cover"
          alt=""
          src="/whatsapp-image-20230406-at-1940-11@2x.png"
        />
        <div className="absolute top-[12.5rem] left-[45rem] text-[4.25rem] font-semibold font-playfair-display text-light-background-color">
          BREAST SELF-EXAM
        </div>
        <img
          ...
          src="/colmd61.svg"
        />
        <div className="absolute top-[18.5rem] left-[45rem] text-[1.03rem] text-light-background-color inline-block w-[31.94rem] h-[4.06rem]">{`Breast self-exam, or regularly examining your breasts on your own, can be an important way to find a breast cancer early, when it’s more likely to be treated successfully. `}</div>
        <div className="absolute top-[42.69rem] left-[calc(50%_-_522px)] flex flex-row items-center justify-start gap-[1.88rem] text-[1rem] text-text-color font-dm-serif-display">
          <div className="h-[7.94rem] overflow-hidden flex flex-col items-start justify-start">
            <div className="rounded-4xs bg-plum-100 w-[20.81rem] overflow-hidden flex flex-col p-[1.56rem] box-border items-center justify-center">
              <div className="overflow-hidden flex flex-row items-start justify-start gap-[1.25rem]">
                <img
                  className="relative w-[0.56rem] h-[1rem] overflow-hidden shrink-0"
                  alt=""
                ...
                <div className="flex flex-col items-start justify-start gap-[0.31rem]">
                  ...
                  <p className="m-0 relative text-[0.88rem] tracking-[0.2px] leading-[1.5rem] font-medium font-poppins text-deeppink inline-block w-[15.63rem]">{`four steps for checking for breast cancer at home. `}</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="rounded-4xs bg-plum-100 w-[20.81rem] overflow-hidden flex flex-col p-[1.56rem] box-border items-center justify-center">
              <div className="overflow-hidden flex flex-row items-start justify-start gap-[1.25rem]">
                ...
                <div className="flex flex-col items-start justify-start gap-[0.31rem]">
                  ...
                  <div className="relative text-[0.88rem] tracking-[0.2px] leading-[1.5rem] font-medium font-poppins text-deeppink inline-block w-[15.63rem]">{`Don’t panic. Don’t hesitate. Know what to expect. `}</div>
                </div>
              </div>
            </div>
          </div>
        </div>
        <div className="absolute top-[42.69rem] left-[57.63rem] h-[7.94rem] overflow-hidden flex flex-row items-center justify-start text-[1rem] text-text-color font-dm-serif-display">
          <div className="rounded-4xs bg-plum-100 w-[20.81rem] overflow-hidden shrink-0 flex flex-col p-[1.56rem] box-border items-center justify-center">
            <div className="overflow-hidden flex flex-row items-start justify-start gap-[1.25rem]">
              <img
                className="relative w-[0.56rem] h-[1rem] overflow-hidden shrink-0"
                alt=""
              ...
              <div className="flex flex-col items-start justify-start gap-[0.31rem]">
                <div className="relative tracking-[0.1px] leading-[1.5rem]">
                  <p className="m-0">{`How to make breast self-exam part `}</p>
                  <p className="m-0">of your cancer screening stratergy?</p>
                </div>
                <div className="relative text-[0.88rem] tracking-[0.2px] leading-[1.5rem] font-medium font-poppins text-deeppink inline-block w-[15.63rem]">
                  Making a routine....
                </div>
              </div>
            </div>
        ...
        <div className="absolute top-[66.19rem] left-[7.88rem] inline-block w-[61.31rem] text-[3rem] font-playfair-display">
          ...
          <i className="font-dm-serif-display text-[2rem] text-deeppink">
            <span>{` `}</span>
            <span>Examine Your Breasts in a Mirror With Hands on Hips</span>
          </i>
        </div>
        <div className="absolute top-[102.94rem] left-[7.88rem] inline-block w-[66.81rem] text-[3rem] font-playfair-display">
          <span>
          ...
          <i className="font-dm-serif-display text-[2rem] text-deeppink">
            <span>{` `}</span>
            <span>
              Raise arms and Examine your Breasts, look for signs of breast fluid
            </span>
          </i>
        </div>
        <div className="absolute top-[144.5rem] left-[7.88rem] inline-block w-[66.81rem] text-[3rem] font-playfair-display">
          ...
          <i className="font-dm-serif-display text-[2.13rem] text-deeppink">
            <span>{` `}</span>
        ...
        <img
          className="absolute top-[230.44rem] left-[0rem] w-[90rem] h-[64.13rem]"
          alt=""
          src="/rectangle-13.svg"
        />
        <div className="absolute top-[240.63rem] left-[6.75rem] text-[2.25rem] font-semibold font-playfair-display text-light-background-color inline-block w-[81.44rem] h-[3.56rem]">
          What to do if you find a breast lump?
        </div>
        <img
        ...
        <div className="absolute top-[245.94rem] left-[6.75rem] inline-block w-[73.5rem] h-[37.31rem] text-[1rem] text-light-background-color">
          <p className="m-0">
            <span className="text-[1.25rem] text-gray-600">
              <span className="font-extrabold font-playfair-display">
          ...
          <p className="m-0">
            <span className="text-light-background-color">
              <span className="text-[1rem] font-medium font-poppins">
                ...
                own before calling your doctor. The best healthcare provider to
                call is the one who knows you and has done a breast exam on you
                before — for example, your gynecologist, your primary care doctor,
                or a nurse practitioner who works with your gynecologist or
                primary care doctor.
              </span>
            </span>
          </p>
          ...
          <p className="m-0">
            <span className="text-[1.25rem]">
              <b className="font-playfair-display text-gray-600">
                Know what to expect.
              </b>
            </span>
            <span className="text-light-background-color">
          ...
          <p className="m-0">
            <span className="text-light-background-color">
              <span className="text-[1rem] font-medium font-poppins">{`At an appointment to evaluate a breast lump, your doctor takes a health history and does a physical exam of the breast, and most likely orders breast imaging tests. Ultrasound is often the first or only imaging test used to evaluate a lump in women who are younger than 30 or are pregnant or breastfeeding. Both an ultrasound and a mammogram are typically recommended to evaluate a lump in women who are older than 30 and not pregnant or breastfeeding. If further testing is needed, your doctor may recommend additional imaging with MRI, MBI (molecular breast imaging), a biopsy, or any combination of these tests. `}</span>
            </span>
          </p>
          <p className="m-0">
            <span className="text-light-background-color">
          ...
          <p className="m-0">
            <span className="text-[1.25rem] font-semibold font-playfair-display">
              <span className="text-gray-600">{`Your doctor may also refer you to a breast specialist (typically, a breast surgeon) for further evaluation. `}</span>
            </span>
          </p>
          <p className="m-0">
            <span className="font-medium">{`Make sure you get answers. It’s important that your doctor explains what is causing the lump or other breast changes and, if necessary, develops a plan for monitoring it or treating it. If you’re not comfortable with your doctor’s advice, don’t hesitate to get a second opinion. This information is provided by `}</span>
            <a
            ...
            <span className="font-medium">
              {" "}
              to support free resources and programming for people affected by
              breast cancer.
            </span>
          </p>
        </div>
          ...
          <p className="m-0 text-[1.13rem] font-poppins">
            <span>
              <span>
                ...
                swollen and tender. If you are no longer having periods, choose a
                day that’s easy to remember, such as the first or last day of the
                month.
              </span>
            </span>
          </p>
        ...
        <div className="absolute top-[348.31rem] left-[0rem] bg-gray-300 w-[90rem] h-[30.13rem]" />
